...
image that is resized via height and with attributes, those attributes won't be honored in the resultant post.
...
== Upgrade Notice ==
When upgrading from 1.2 or earlier please reset your admin configuration settings as the names have changed.
